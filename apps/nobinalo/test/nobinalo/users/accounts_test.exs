defmodule Nobinalo.Users.AccountsTest do
  ...
  describe "accounts" do
    ...
    @valid_attrs %{display_name: "some display_name", is_active: true}
    @update_attrs %{display_name: "some updated display_name", is_active: false}
    @invalid_attrs %{display_name: nil, is_active: nil}
